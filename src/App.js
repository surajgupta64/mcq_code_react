...
const API_URL = [
  {
    ...
    difficulty: "hard",
    question:
      "What was the name of the hero in the 80s animated video game Dragon Lair",
  ...
  },
  {
    ...
    difficulty: "medium",
    question:
      "What is the name of the device that allows for infinite energy in the anime  Dimension",
...
function App() {
  ...
  useEffect(() => {
    const questions = API_URL.map((question) => ({
      ...question,
    ...
    <div className="container">
      <div className="mainContainer">
        ...
        {currentIndex >= questions.length ? (
          ...
          <Questionaire
            rating={questions[currentIndex].difficulty}
            handleAnswer={handleAnswer}
            showAnswers={showAnswers}
            handleNextQuestion={handleNextQuestion}
            questionlength={questions.length}
            categoryQuestion={questions[currentIndex].category}
